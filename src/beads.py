...
# Mn = CgBead("Mn", sigma=2.0, connectivity=0, angle_centered=180)
...
# Ni = CgBead("Ni", sigma=2.0, connectivity=0, angle_centered=180)
...
# O = CgBead("O", sigma=2.0, connectivity=0, angle_centered=180)
...
# CgBead("Pb", sigma=2.0, connectivity=3, angle_centered=60),
# CgBead("Li", sigma=2.0, connectivity=3, angle_centered=60),
# CgBead("Lu", sigma=2.0, connectivity=3, angle_centered=60),


def beads_1c():
    return (
        CgBead("Cl", sigma=3.0, connectivity=1, angle_centered=40),
        ...
        CgBead("Cs", sigma=4.0, connectivity=1, angle_centered=160),
...
def beads_3c():
    return (
        CgBead("Ho", sigma=2.0, connectivity=3, angle_centered=60),
        CgBead("Fe", sigma=2.5, connectivity=3, angle_centered=60),
        CgBead("In", sigma=3.0, connectivity=3, angle_centered=60),
        CgBead("I", sigma=3.5, connectivity=3, angle_centered=60),
        CgBead("Ir", sigma=4.0, connectivity=3, angle_centered=60),
    )


def beads_4c():
    return (CgBead("Pt", 2.0, 4, (90, 180)),)
