# I am a script to test the tests for this PR.
...
def analyse_cage(
    ...
    final_molecule = cgx.utilities.AtomliteDatabase(
        conformer_db_path
...
def main() -> None:  # noqa: PLR0915
    ...
    structure_dir = wd / "structures"
    cgx.utilities.check_directory(structure_dir)
    ...
    if args.run:
        for system_name, syst_d in systems.items():
            ...
            for multiplier in syst_d["multipliers"]:
                ...
                nmetals = syst_d["stoichiometry_map"]["tetra"] * multiplier
